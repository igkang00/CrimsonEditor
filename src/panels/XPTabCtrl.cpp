...
BEGIN_MESSAGE_MAP(CXPTabCtrl, CTabCtrl)
	...
	ON_NOTIFY_REFLECT_EX(TCN_SELCHANGE, OnTabSelChanged) //<----- CHANGED
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
//----------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------
BOOL CXPTabCtrl::OnTabSelChanged(NMHDR* pNMHDR, LRESULT* pResult) //<--- returntype
{
	UNUSED_ALWAYS(pNMHDR);
